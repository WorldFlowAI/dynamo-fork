    ...
    async def test_semantic_to_radixtree_handoff(self):
        ...
        event_0 = json.dumps({
            ...
            "data": {
                "stored": {
                    "parent_hash": None,
                    "blocks": [{"block_hash": block_hashes[0], "tokens_hash": block_hashes[0]}],
                }
            },
        }).encode()
        ...
        event_1 = json.dumps({
            ...
            "data": {
                "stored": {
                    ...
                    "blocks": [{"block_hash": block_hashes[1], "tokens_hash": block_hashes[1]}],
                }
            },
        }).encode()
        ...
        donor_block_hashes = compute_block_hash_for_seq(
            match.donor_token_ids, 32
        )
